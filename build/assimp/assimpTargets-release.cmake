...
if(MSVC)
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_IMPLIB_RELEASE "/usr/local/lib/${importLibraryName}"
      IMPORTED_LOCATION_RELEASE "/usr/local/bin/${sharedLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "/usr/local/lib/${importLibraryName}")
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "/usr/local/bin/${sharedLibraryName}" )
  else()
    ...
    set_property(TARGET assimp::assimp APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_LOCATION_RELEASE "/usr/local/lib/${staticLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "/usr/local/lib/${staticLibraryName}")
  endif()
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    if(WIN32)
      ...
      set(sharedLibraryName "libassimp${ASSIMP_LIBRARY_SUFFIX}.dylib.a")
    elseif(APPLE)
    ...
    set_target_properties(assimp::assimp PROPERTIES
      ...
      IMPORTED_LOCATION_RELEASE "/usr/local/lib/${sharedLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
    list(APPEND _IMPORT_CHECK_FILES_FOR_assimp::assimp "/usr/local/lib/${sharedLibraryName}" )
  else()
